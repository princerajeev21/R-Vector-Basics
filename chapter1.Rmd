...
*       - **Numeric Vector** - one that contains only numeric values (integer of float).
*       - **Character Vector** - one that contains either single character values or strings as values.
*       - **Logical Vector** - one that contains logical values (TRUE or FALSE).
